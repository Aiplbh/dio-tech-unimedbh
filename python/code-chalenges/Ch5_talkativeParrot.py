...
# 1) ideia usar um dicionario

parrot_dict = {'esquerda' : 'ingles', 'direita' : 'frances', 'nenhuma' : 'portugues', 'ambas' : 'caiu'}
...
while True: 
    try: 
        ...
        # 2) receber string de comando

        voice_command = input()
        if (voice_command == '.'):
            break
        
        # 3) imprimir valor conforme chave fornecida

        print (parrot_dict.get(voice_command))
